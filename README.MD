...
Pour faciliter ces tests, le script `test_vad.sh` automatise l'exécution de `vad.py` avec 5 combinaisons de paramètres stratégiques.
...
Le script créera un dossier `test_vad/` avec les sous-dossiers suivants :
